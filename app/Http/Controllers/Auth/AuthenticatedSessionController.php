...
class AuthenticatedSessionController extends Controller
{
    ...
    public function store(LoginRequest $request)
    {
        ...
        $validated = validator($request->all(), $validation)->validate();
        ...
        $timezone = $setting['timezone'] ? $setting['timezone'] : 'Africa/Nairobi';
    ...
    public function destroy(Request $request)
    {
        ...
        // ToastMagic::success('Logged out Successifully ');
    ...
    public function showCustomerLoginForm($lang = null)
    {
        ...
        \App::setLocale($lang);
        $pageConfigs = ['myLayout' => 'blank'];
        return view('auth.customer_login', ['pageConfigs' => $pageConfigs]);
    }
    ...
    {
        if (!$lang) {
            $lang = Utility::getValByName('default_language'); // Get default language if none is provided
        }
        ...
        $settings = Utility::settings();
        $pageConfigs = ['myLayout' => 'blank'];
        return view('auth.login', ['settings' => $settings, 'pageConfigs' => $pageConfigs]);
    }
    ...
    public function showCustomerLinkRequestForm($lang = '')
    {
        ...
        \App::setLocale($lang);
        $pageConfigs = ['myLayout' => 'blank'];
        return view('auth.passwords.customerEmail', ['pageConfigs' => $pageConfigs]);
    }
    ...
    {
        // Adding pageConfigs to ensure the minimal layout is used
    ...
    {
        return view('auth.passwords.customerReset', [
            'token'       => $token,
            'pageConfigs' => ['myLayout' => 'blank'],
        ]);
    }
