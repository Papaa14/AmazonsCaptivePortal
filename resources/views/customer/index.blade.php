            ...
            <div class="card">
                <div class="card-body table-border-style">
                    <div class="table-responsive">
                        <table class="table mb-6 datatabl">
                            <thead>
                                <tr>
                                    <th>Fullname</th>
                                    <th>Account</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($customer->is_active == 0)
                                            {!! Form::open(['method' => 'DELETE', 'route' => ['customer.destroy', $customer->id], 'id' => 'delete-form-' . $customer->id, 'style' => 'display:inline']) !!}
                                                <button type="submit" class="text-danger" data-bs-toggle="tooltip" title="{{ __('Delete customer') }}"
                                                    data-confirm="{{ __('Are you sure you want to delete this customer account?') }}">
