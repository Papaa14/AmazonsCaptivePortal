{{ Form::model($sms, ['route' => ['sms.update', $sms->id], 'method' => 'PUT', 'class'=>'needs-validation', 'novalidate']) }}
    <div class="modal-body">
        <div class="row g-2">
            <div class="form-group col-md-12">
                {{ Form::label('type', __('Template Name'), ['class' => 'form-label']) }}<x-required></x-required>
                {{ Form::text('type', null, ['class' => 'form-control', 'required' => true, 'readonly' => true, 'placeholder' => __('Enter Template Name')]) }}
            </div>
            <div class="form-group col-md-12">
