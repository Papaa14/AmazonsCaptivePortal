...
<div class="modal-body">
    <div class="row">
        @if (\Auth::user()->type == 'super admin')
            ...
            <div class="col-md-6 mb-3">
                <div class="form-group">
                    {{ Form::label('phone', __('Phone Number'), ['class' => 'form-label']) }}<x-required></x-required>
                    {{ Form::number('phone', null, ['class' => 'form-control', 'placeholder' => __('Enter Company Phone Number'), 'required' => 'required']) }}
                    @error('phone')
            ...
            <div class="col-md-6 mb-3">
                <div class="form-group">
                    ...
                    {{ Form::text('location', null, ['class' => 'form-control', 'placeholder' => __('Enter Company Location'), 'required' => 'required']) }}
                    @error('location')
            ...
            <div class="col-md-6 mb-3">
                <div class="form-group">
                    ...
                    {{ Form::text('owner', null, ['class' => 'form-control', 'placeholder' => __('Enter Owner Fulllname'), 'required' => 'required']) }}
                    @error('owner')
